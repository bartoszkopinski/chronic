...
module Chronic
  class Parser
    ...
    def pre_normalize(text)
      ...
      text.gsub!(/\b(przed ?wczoraj)\b/, '2 days ago')
      text.gsub!(/\b(today|dzisiaj|dzi[sś])\b/, 'this day')
      text.gsub!(/\b(tomm?orr?ow|jutro)\b/, 'next day')
      text.gsub!(/\b(yesterday|wczoraj)\b/, 'last day')
      text.gsub!(/\b(noon|midday|po[lł]udnie)\b/, '12:00pm')
      text.gsub!(/\b(midnight|p[oó][lł]noc)\b/, '24:00')
      text.gsub!(/\b(now|teraz|przed chwil[ąa]|w tej chwili)\b/, 'this second')
      text.gsub!(/\b(quarter|kwadrans)\b/, '15')
      ...
      text.gsub!(/\b(tonight|dzisiejszej nocy)\b/, 'this night')
